...
const FAQS = () => {
    ...
    <AccordionItem value="item-1">
      <AccordionTrigger>What is Tronic?</AccordionTrigger>
      <AccordionContent>
        Tronic serveices is a full fledge marketing agency that specializes in branding, web design, and digital marketing.
      </AccordionContent>
    </AccordionItem>
    ...
    Pricing ?
      ...
      <AccordionContent>
        ...
        if you have a budget we will inform you on what we can offer. 
