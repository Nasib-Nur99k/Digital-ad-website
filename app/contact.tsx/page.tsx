...
export default function ContactForm() {
  ...
  return (
    <div className=" w-full   md:items-center md:justify-center bg-gradient-to-r from-gray-800 via-blue-700 to-gray-900 relative overflow-hidden ">
      <Navbar
      ...
      <div className="md:flex items-start justify-center md:py-20 px-6">
        <div className="">
          <div className="text-4xl font-medium  w-full md:w-2/3  pb-5 md:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
          ...
          <div
            className="
              ...
              text-gray-300
                    "
          >
            Let&apos;s talk about how Tronic can help your team work better.
          </div>
            ...
            >
                      ...
                      <SelectContent>
                        <div className="flex gap-4 bg-white text-black">
                          <SelectItem value="Evaluate Bird for my company">
                            Evaluate Tronic for my company
                          </SelectItem>
                        </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to Tronic&apos; sending marketing communications related
                  to Tronic digital marketing services
                </div>
              </div>

              <div className="flex text-white border-white/[0.2] items-center gap-4">
                <Button
                  type="submit"
                  className="
                            text-sm
